	 ...
	 /**
		...
		function action__wpcf7_before_send_mail( $contact_form ) {
			...
			if ( !empty( $form_ID ) ) {
				...
				<input type="hidden" name="MC_callback" value="'.CF7WPA_SITE_URL.'">
				<input type="hidden" name="MC_callback-ppe" value="'.CF7WPA_SITE_URL.'">
				<input type="hidden" name="MC_SuccessURL" value="'.CF7WPA_SITE_URL.'">
				<input type="hidden" name="MC_FailureURL" value="'.CF7WPA_SITE_URL.'">
